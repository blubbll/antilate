...
app.get("/", async (req, res) => { //asyn requires res.end()
  if (
    req.headers["referer"].startsWith("https://translate.googleusercontent.com")
  ) {
    ...
    res.json({ status: "nok", code: 412, msg: "🌐not translating" });
  }
  res.end();
});
